            ...
            <div class="col">
                ...
                <div>
                    ...
                    <section class="scroll-section" id="bootstrapValidation">
                        ...
                        <div class="card mb-5">
                            <div class="card-body">
                                <form class="row g-3 needs-validation" method="POST" action="/factor" novalidate>
                                    @csrf
                                    {{-- <div class="col-12">
                                        <div class="w-100">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea rows="4" type="text" class="form-control ckeditor" name="rain_assumption" required></textarea>
                                        <x-form-error name="rain_assumption" />
                                    </div>
                                    <div class="col-12">
                                        <label for="land_soility" class="form-label">Land soility</label>
                                        <textarea rows="4" type="text" class="form-control ckeditor" name="land_soility" required></textarea>
                                        <x-form-error name="land_soility" />
                                    </div>
                                    <div class="col-12">
                                        <label for="forest_assumption" class="form-label">Forest assumption</label>
                                        <textarea rows="4" type="text" class="form-control ckeditor" name="forest_assumption" required></textarea>
                                        <x-form-error name="forest_assumption" />
                                    </div>
                                    <div class="col-12">
                                        <label for="temperature" class="form-label">Temperature</label>
                                        <textarea rows="4" type="text" class="form-control ckeditor" name="temperature" required></textarea>
                                        <x-form-error name="temperature" />
                                    </div>
                                    <div class="col-12">
                                        <label for="perception" class="form-label">Perception</label>
                                        <textarea rows="4" type="text" class="form-control ckeditor" name="perception" required></textarea>
                                        <x-form-error name="perception" />
                                    </div>
                                    <div class="col-12">
                                        <label for="humidity" class="form-label">Humidity</label>
                                        <textarea rows="4" type="text" class="form-control ckeditor" name="humidity" required></textarea>
                                        <x-form-error name="humidity" />
                                    </div>
                                    <div class="col-12">
                                        <label for="warning_alerts" class="form-label">Warning alerts</label>
                                        <textarea rows="4" type="text" class="form-control ckeditor" name="warning_alerts" required></textarea>
                                        <x-form-error name="warning_alerts" />
                                    </div>
                                    <div class="col-12">
                                        <label for="wind" class="form-label">Wind</label>
                                        <textarea rows="4" type="text" class="form-control ckeditor" name="wind" required></textarea>
                                        <x-form-error name="wind" />
                                    </div>
                                    <div class="col-12">
                                        <label for="air_quality" class="form-label">Air quality</label>
                                        <textarea rows="4" type="text" class="form-control ckeditor" name="air_quality" required></textarea>
                                        <x-form-error name="air_quality" />
                                    </div>
                                    <div class="col-12">
                                        <label for="climate_change_note" class="form-label">Climate change
                                            note</label>
                                        <textarea rows="4" type="text" class="form-control ckeditor" name="climate_change_note" required></textarea>
                                        <x-form-error name="climate_change_note" />
                                    </div>
                                    <div class="col-12">
                                        <label for="co2_assumption" class="form-label">Co2 assumption</label>
                                        <textarea rows="4" type="text" class="form-control ckeditor" name="co2_assumption" required></textarea>
